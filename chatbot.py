...
def crawl_hotNews():
    ...
    for new in news_list:
        ...
        hot_news.append([a_obj['href'],title_obj.get_text(),content_obj.get_text()])
    return hot_news
            ...
            template=CarouselTemplate(
                columns=[
                    CarouselColumn(
                        ...
                        text=hot_news[2][0],
                        actions=[
                            URIAction(uri=hot_news[0][0], label='label')
                        ]
                    ),
                    CarouselColumn(
                        thumbnail_image_url=r'https://www.google.com.hk/images/branding/googlelogo/2x/googlelogo_color_272x92dp.png',
                        ...
                        text=hot_news[2][1],
                        actions=[
                            URIAction(uri=hot_news[0][1], label='label')
                        ]
                    ),CarouselColumn(
                        thumbnail_image_url=r'https://www.google.com.hk/images/branding/googlelogo/2x/googlelogo_color_272x92dp.png',
                        title=hot_news[1][2],
                        ...
                        text=hot_news[2][3],
                        actions=[
                            URIAction(uri=hot_news[0][3], label='label')
                        ]
                    ),
                    CarouselColumn(
                        thumbnail_image_url=r'https://www.google.com.hk/images/branding/googlelogo/2x/googlelogo_color_272x92dp.png',
                        ...
                        text=hot_news[2][4],
                        actions=[
                            URIAction(uri=hot_news[0][4], label='label')
                        ]
                    )
                ]
            )
